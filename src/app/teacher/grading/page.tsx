...
export default async function GradingPage() {
  ...
  // 채점 대기 중인 주관식 답안 (essay questions, not graded)
    ...
    <div className="p-4 md:p-7">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-4">
          <h2 className="font-bold text-gray-900">채점 대기</h2>
          {filtered.length > 0 && (
        ...
        {filtered.length === 0 ? (
          <div className="bg-white rounded-2xl border border-gray-100 p-10 text-center">
            ...
            <p className="font-semibold text-gray-500">채점 대기 중인 답안이 없어요</p>
            <p className="text-sm text-gray-400 mt-1">주관식 문제 답안이 제출되면 여기에 나타납니다</p>
          </div>
        ) : (
